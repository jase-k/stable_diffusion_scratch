...
class SelfAttention(nn.Module):
    ...
    # d_embed represents the multiple channels of each pixel
    def __init__(self, n_heads: int, d_embed: int, in_proj_bias=True, out_proj_bias=True):
        super().__init__()
        
        # Multiplying 3 because rgb
    ...
    def forward(self, x: torch.Tensor, causal_mask=False) -> torch.Tensor:
        ...
        q = q.view(intermin_shape).transpose(1, 2) # Transpose: https://pytorch.org/docs/stable/generated/torch.transpose.html
